#!/bin/bash
#SBATCH --job-name="InfSG"
#SBATCH --partition=v100-32g
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=3-00:00
#SBATCH --chdir=.
#SBATCH --output=ioutsg.txt
#SBATCH --error=ierrsg.txt
###SBATCH --test-only
...
python3 inference.py --config-file ../configs/sg_dev_masktransfer_rebar.yaml --num-gpus 1 --resume DATALOADER.NUM_WORKERS 2 \
