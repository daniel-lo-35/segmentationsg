#!/bin/bash
#SBATCH --job-name="VGVCTree"
#SBATCH --partition=v100-32g
#SBATCH --ntasks=4
#SBATCH --gres=gpu:1
#SBATCH --time=3-00:00
#SBATCH --chdir=.
#SBATCH --output=step3vcouts-vg-cl.txt
#SBATCH --error=step3vcerrs-vg-cl.txt
###SBATCH --test-only
...
python3 train_SG_segmentation_head.py --config-file ../configs/sg_dev_masktransfer.yaml --num-gpus 1 --resume DATALOADER.NUM_WORKERS 2 \
MODEL.WEIGHTS ../output-step1-vg/resnet_pretrain_weights.pth \
OUTPUT_DIR ../output-step3-predcl-vctree-short-vg \
