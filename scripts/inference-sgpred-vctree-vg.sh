...
#SBATCH --time=3-00:00
#SBATCH --chdir=.
#SBATCH --output=ioutsgvg.txt
#SBATCH --error=ierrsgvg.txt
###SBATCH --test-only
...
python3 inference.py --config-file ../configs/sg_dev_masktransfer.yaml --num-gpus 1 --resume DATALOADER.NUM_WORKERS 2 \
